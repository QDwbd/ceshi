...
import { ArrowForward, GitHub, IosShare, Settings } from "@mui/icons-material";
import {
  Chip,
  CircularProgress,
  IconButton,
...
const SettingVerge = ({ onError }: Props) => {
  ...
  const { language, disable_auto_check_update } = verge ?? {};
  ...
  return (
    <SettingList title={t("lucky Setting")}>
      ...
      <SettingItem label={t("lucky Version")}>
      ...
      <SettingItem label="GitHub">
        <IconButton
          ...
          size="small"
          sx={{ my: "2px" }}
          onClick={() => openWebUrl("https://github.com/QDwbd/lucky")}
        >
