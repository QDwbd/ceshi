...
!macro CheckluckyProcess Process ID
  !if "${INSTALLMODE}" == "currentUser"
...
!macro CheckAllluckyProcesses
  !insertmacro CheckluckyProcess "lucky.exe" "1"
  ; !insertmacro CheckluckyProcess "clash-verge-service.exe" "2"
  !insertmacro CheckluckyProcess "clash.exe" "3"
  !insertmacro CheckluckyProcess "clash-rs.exe" "4"
  !insertmacro CheckluckyProcess "mihomo.exe" "5"
  !insertmacro CheckluckyProcess "mihomo-alpha.exe" "6"
!macroend

Section CheckProcesses
  !insertmacro CheckAllluckyProcesses
SectionEnd
