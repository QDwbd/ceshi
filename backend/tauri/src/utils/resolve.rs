...
pub fn create_window(app_handle: &AppHandle) {
    ...
    .unwrap() // WindowBuilder::icon 在 tauri 1.5 返回 Result<Self>
    .fullscreen(false)
    ...
    #[cfg(target_os = "windows")]
    {
            ...
            .build()
        {
            Ok(win) => {
                ...
                trace_err!(set_shadow(&win, false), "disable win shadow");
    ...
    #[cfg(target_os = "linux")]
    crate::log_err!(builder.decorations(false).transparent(true).build());
