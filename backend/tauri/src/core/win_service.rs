...
pub async fn check_service() -> Result<JsonResponse> {
    ...
    let response = reqwest::ClientBuilder::new()
        ...
        .send()
        .await
        .context("failed to connect to the lucky Service")?
        .json::<JsonResponse>()
        .await
        .context("failed to parse the lucky Service response")?;
