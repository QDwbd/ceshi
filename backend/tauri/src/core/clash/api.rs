...
pub struct ProxyItem {
    ...
    pub alive: Option<bool>, // Mihomo Only
...
fn test_parse_check_output() {
    let str1 = r#"xxxx\n time="2025-06-06T20:20:20+08:00" level=error msg="proxy 0: 'alpn' expected type 'string', got unconvertible type '[]interface {}'""#;
    let str2 = r#"20:20:20 ERR [Config] configuration file test failed error=proxy 0: unsupport proxy type: hysteria path=xxx"#;
    let str3 = r#"
    "time="2025-06-06T20:20:20+08:00" level=info msg="Start initial configuration in progress"
    time="2025-06-06T20:20:20+08:00" level=error msg="proxy 0: 'alpn' expected type 'string', got unconvertible type '[]interface {}'"
